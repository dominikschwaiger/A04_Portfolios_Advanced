***corrected version after presenting exercise 2****
---
title: "Portfoliomanagement and Financial Analysis - Assignment 4"
subtitle: "Submit until Monday 2020-10-12, 13:00"
...
First, we created a vector with the stocks we want to observe. We take AAPL, MSFT, AMZN, JPM. We get the prices and transmute thme to returns. We create the monthly returns and create 4 columns for each stock with the simple returns from adjusted prices and convert them into xts. 
```{r}
...
colnames(R) <- c("AMZN","ADBE","MSFT","JNJ","PG","AXP","BAC","AAPL","T","CAT")
funds <- colnames(R)
...
```{r}
stockselection_4 <- c("AMZN","ADBE","MSFT","JNJ","PG","AXP","BAC","AAPL","T","CAT", "^GSPC")
stockselection_4
# Presettings
